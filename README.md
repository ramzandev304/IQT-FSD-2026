...
- **Implementation:** [backend/src/routes/currency.js](backend/src/routes/currency.js)
  ...
  endpoint.
- **GitHub commit showing the work:**
  https://github.com/ramzandev304/qt-fsd-task-manager/commit/01f029465f7cc8aac9f03f03f187baf20d973a08
...
- [x] Step 3 API integration + screenshot + commit: see above / [screenshots/response.png](screenshots/response.png)
